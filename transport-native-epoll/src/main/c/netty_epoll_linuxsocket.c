...
static void netty_epoll_linuxsocket_getTcpInfo(JNIEnv* env, jclass clazz, jint fd, jlongArray array) {
     ...
     cArray[6] = (jlong) (unsigned long long) tcp_info.tcpi_snd_wscale;
     cArray[7] = (jlong) (unsigned long long) tcp_info.tcpi_rcv_wscale;
     cArray[8] = (jlong) (unsigned long long) tcp_info.tcpi_rto;
     cArray[9] = (jlong) (unsigned long long) tcp_info.tcpi_ato;
     cArray[10] = (jlong) (unsigned long long) tcp_info.tcpi_snd_mss;
     cArray[11] = (jlong) (unsigned long long) tcp_info.tcpi_rcv_mss;
     cArray[12] = (jlong) (unsigned long long) tcp_info.tcpi_unacked;
     cArray[13] = (jlong) (unsigned long long) tcp_info.tcpi_sacked;
     cArray[14] = (jlong) (unsigned long long) tcp_info.tcpi_lost;
     cArray[15] = (jlong) (unsigned long long) tcp_info.tcpi_retrans;
     cArray[16] = (jlong) (unsigned long long) tcp_info.tcpi_fackets;
     cArray[17] = (jlong) (unsigned long long) tcp_info.tcpi_last_data_sent;
     cArray[18] = (jlong) (unsigned long long) tcp_info.tcpi_last_ack_sent;
     cArray[19] = (jlong) (unsigned long long) tcp_info.tcpi_last_data_recv;
     cArray[20] = (jlong) (unsigned long long) tcp_info.tcpi_last_ack_recv;
     cArray[21] = (jlong) (unsigned long long) tcp_info.tcpi_pmtu;
     cArray[22] = (jlong) (unsigned long long) tcp_info.tcpi_rcv_ssthresh;
     cArray[23] = (jlong) (unsigned long long) tcp_info.tcpi_rtt;
